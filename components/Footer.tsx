...
const Footer = () => {
  return (
    <footer className="relative w-full bg-[#DBC7C4] pt-16 lg:pt-24 pb-8 lg:pb-10 overflow-hidden text-[#1E3147]">
      {/* Background Graphic Initials */}
      <div className="absolute right-[-10%] lg:right-[0%] bottom-[-5%] lg:bottom-[0%] w-[110%] lg:w-[76%] pointer-events-none z-0">
        <Image
      ...
      <div className="max-container relative z-10 px-6 lg:px-12 mx-auto">
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mt-12 lg:mt-40">
          ...
          <p className="text-[13px] text-[#2F223B]font-medium tracking-tight">
