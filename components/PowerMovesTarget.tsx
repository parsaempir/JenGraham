    ...
    <section className="bg-[#F9F5F2] w-full pt-16 sm:pt-20 lg:pt-24 pb-16 lg:pb-0 overflow-hidden">
      <div className="max-container px-6 lg:px-12 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-28 items-center">
        ...
        <div className="flex flex-col mt-0 lg:-mt-40 justify-center">
          <h2 className="font-serif text-[30px] sm:text-[40px] lg:text-[48px] text-[#2D3643] leading-[1.2] lg:leading-[1.1] mb-8 lg:mb-10 font-normal">
            Power Moves is built specifically for women leading in corporate sales environments who are ready to
          </h2>

          <ul className="mb-6 lg:mb-4 text-[#2D3643] text-[18px] sm:text-[20px] lg:text-[22px] font-normal leading-[1.2] lg:leading-[1.15]">
          ...
          <div className="text-[#2D3643] text-[18px] sm:text-[20px] lg:text-[22px] leading-[1.2] lg:leading-[1.15] font-normal space-y-2 lg:space-y-0">
