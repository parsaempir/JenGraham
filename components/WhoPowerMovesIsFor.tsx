...
const WhoPowerMovesIsFor = () => {
  ...
  return (
    <section className="bg-[#DBC7C4] w-full py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="absolute left-[40%] top-[70%] -translate-x-1/2 -translate-y-1/2 w-225 lg:w-350 h-225 lg:h-350 z-0 pointer-events-none">
        <Image 
      ...
      <div className="max-container flex flex-col items-center text-center mb-12 lg:mb-16 relative z-10 px-6 lg:px-0">
        <h2 className="font-serif text-[2rem] md:text-5xl lg:text-[3.5rem] text-[#2D3643] mb-6 font-normal">
      ...
      <div className="max-container mb-16 lg:mb-24 relative z-10 px-6 lg:px-0">
        <div className="border border-[#2D3643] rounded-[1.875rem] lg:rounded-full py-6 lg:py-8 px-6 md:px-16 lg:px-24 grid grid-cols-2 lg:flex lg:flex-nowrap justify-between items-start lg:items-center gap-y-10 gap-x-6 lg:gap-6 w-full mx-auto">
          {/* Item 1 */}
          <div className="flex flex-col lg:flex-row items-center gap-2 lg:gap-4">
            <Image src="/The Accelerator/clock-01.svg" alt="Clock" width={32} height={32} className="w-6 lg:w-8 h-auto" />
            <span className="text-[#2D3643] font-medium tracking-wider uppercase text-[0.75rem] lg:text-lg text-center lg:text-left">6 Months</span>
          </div>
          {/* Item 2 */}
          <div className="flex flex-col lg:flex-row items-center gap-2 lg:gap-4">
            <Image src="/The Accelerator/left-to-right-list-dash.svg" alt="List" width={32} height={32} className="w-6 lg:w-8 h-auto" />
            <span className="text-[#2D3643] font-medium tracking-wider uppercase text-[0.75rem] lg:text-lg text-center lg:text-left">Sales Leadership</span>
          </div>
          {/* Item 3 */}
          <div className="flex flex-col lg:flex-row items-center gap-2 lg:gap-4">
            <Image src="/The Accelerator/body-part-muscle.svg" alt="Muscle" width={32} height={32} className="w-6 lg:w-8 h-auto" />
            <span className="text-[#2D3643] font-medium tracking-wider uppercase text-[0.75rem] lg:text-lg text-center lg:text-left">Energy & Strength</span>
          </div>
          {/* Item 4 */}
          <div className="flex flex-col lg:flex-row items-center gap-2 lg:gap-4">
            <Image src="/The Accelerator/organic-food.svg" alt="Leaf" width={32} height={32} className="w-6 lg:w-8 h-auto" />
            <span className="text-[#2D3643] font-medium tracking-wider uppercase text-[0.75rem] lg:text-lg text-center lg:text-left">Confidence</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-container grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 relative z-10 px-6 lg:px-0">
        ...
        <div className="flex flex-col space-y-12 justify-center order-2 lg:order-1">
          ...
          <div className="border-b border-transparent pb-4">
            ...
            >
              <h3 className="font-serif text-2xl lg:text-[2.125rem] text-[#2D3643] font-normal">What You Get?</h3>
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openSection === "what" ? "max-h-[62.5rem] opacity-100" : "max-h-[0rem] opacity-0"}`}>
              <div className="text-[#2D3643] font-light space-y-8 pr-4">
                <ul className="space-y-3 text-base lg:text-lg pl-4">
                  <li className="flex items-start">
                    <span className="mr-3 mt-2.5 block w-[0.3125rem] h-[0.3125rem] rounded-full bg-[#2D3643] flex-shrink-0"></span>
          ...
          <div className="pb-4">
            ...
            >
              <h3 className="font-serif text-2xl lg:text-[2.125rem] text-[#2D3643] font-normal">Who This Is For</h3>
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${openSection === "who" ? "max-h-[62.5rem] opacity-100 mt-8" : "max-h-[0rem] opacity-0"}`}>
        ...
        {/* Right: Images */}
        <div className="relative w-full h-[28.125rem] md:h-175 flex justify-center items-center order-1 lg:order-2 mb-12 lg:mb-0">
